    ...
    while (true) {
        ...
        if (*carros > 0) {
            ...
            *carros -= 1;
            ...
            cout << "El kiosco " << kiosco->id << " (" << (kiosco->esCompass ? "Compass" : "Efectivo") << ") atendió un carro. Carros restantes: " << *carros << endl;
...
int main() {
    ...
    // Mostrar resultados
    cout << "Tiempo total de atención para carros con pago Compass: " << tiempo_total_compass << " segundos" << endl;
    cout << "Tiempo promedio de atención por carro con pago Compass: " << tiempo_promedio_compass << " segundos" << endl;
    cout << "Tiempo total de atención para carros con pago Efectivo: " << tiempo_total_efectivo << " segundos" << endl;
    cout << "Tiempo promedio de atención por carro con pago Efectivo: " << tiempo_promedio_efectivo << " segundos" << endl;
